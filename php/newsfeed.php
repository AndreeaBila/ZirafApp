...
<html lang="en">
  ...
  <body id='bodyID'>
    <div id="wrapper" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
      ...
      <!-- Newsfeed content -->
      <div id="newsfeed">
        <!-- php script for dynamically adding the exec newsffed bar -->
        <?php
          //check if the user has the appropriate clearnece
          if(checkClearance()){
            //if the user has executive clearnace include the exec bar
            include './phpComponents/newsfeedExecBar.php';
          }
        ?>
        <div id="newsfeedPostBody">
        </div>
      </div> 
